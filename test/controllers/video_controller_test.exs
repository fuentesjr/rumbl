defmodule Rumbl.VideoControllerTest do
  ...
  @tag login_as: "max"
  test "list all user's videos on video index page",
    %{conn: conn, user: user} do

    user_video = insert_video(user, title: "funny cats")
    other_video =
      insert_user(username: "other")
        |> insert_video(title: "anotheer video")
  ...
  @tag login_as: "max"
  test "creates user video and redirects to video index page",
    %{conn: conn, user: user} do
  ...
  @tag login_as: "max"
  test "renders error and does not create video when invalid",
    %{conn: conn} do
  ...
  test "authorizes actions against access by other users",
    ...
    other_user = insert_user(username: "bobby_tbls")
